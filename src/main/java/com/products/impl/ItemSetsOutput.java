...
public class ItemSetsOutput implements MinerResultOutput {
    ...
    public String getFileName() {
        return Constants.OUTPUT_FILE_SET;
    }

    @Override
    public String getStartMessage() {
        return Constants.MSG_KEY_WRITING_SET_FILE_START;
    }

    @Override
    public String getSuccessMessage() {
        return Constants.MSG_KEY_WRITING_SET_FILE_SUCCESS;
    }
